...
export async function GET(request: Request) {
  ...
  // App icons usually need to look solid in the manifest. We'll use the Kettle Track green background with a white logo for maximum visibility, or black background.
  // Let's stick to the dark theme icon style since that's what the user wants.
  const bg = '#000000'
  const fg = '#1cc29f'
