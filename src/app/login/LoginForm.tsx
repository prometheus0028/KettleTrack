  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] bg-[var(--background)] p-4 font-sans selection:bg-[#1cc29f] selection:text-white">
      ...
      <div className="w-full max-w-[340px] flex flex-col items-center relative z-10 animate-fade-in">
        ...
        {/* Animated Kettle Logo */}
        <div className="w-24 h-24 mb-6 relative flex items-center justify-center animate-float">
          <div className="absolute inset-0 bg-[#1cc29f] opacity-10 rounded-full blur-xl animate-pulse-slow"></div>
          
          <div className="relative w-16 h-16">
            {/* Background (empty) kettle */}
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              viewBox="0 0 470 512.45"
              className="absolute inset-0 w-full h-full text-[var(--border)]"
            >
